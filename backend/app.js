...
const connectDB = async () => {
  try {
    ...
    console.error("   1. Your IP is not whitelisted in Atlas → go to Atlas > Network Access > Add IP");
    console.error("   2. The cluster is paused → go to Atlas and resume it");
    console.error("   3. Wrong MONGO_URI in .env");
    process.exit(1);
  }
};
...
// All payment routes handled by paymentRoutes (routes/payments.js)
